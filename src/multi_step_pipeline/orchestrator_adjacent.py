...
class OrchestratorAdjacent():
    ...
    def start(self):
        ...
        self.clustering_first_stage.set_required_fields(building_centroids_layer=preprocessing_result.building_centroids,
                                                        id_labels=translated_nodes)
